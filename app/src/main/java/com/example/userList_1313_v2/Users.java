...
import com.example.userList_1313_v2.database.UserBaseHalper;
...
public class Users {
    ...
    private UserCursorWrapper queryUsers() {
        Cursor cursor = database.query(UserDBSchema.UserTable.NAME, null, null, null, null, null, null, null);
